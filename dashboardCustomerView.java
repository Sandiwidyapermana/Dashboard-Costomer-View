...
public class dashboardCustomerView extends cDashboardFrame{
  ...
  private cBigFont valueSisaPulsaBeranda = new cBigFont("5", 25, 60);
  private cLabelInfo labelSisaKuotaBeranda = new cLabelInfo("Sisa Vitamin Anda", 25, 150);
  private cBigFont valueSisaKuotaBeranda = new cBigFont("2", 25, 190);

  // Beli Pulsa components
  private cLabelInfo labelSisaPulsaBeliPulsa = new cLabelInfo("Sisa Telur Anda", 25, 20);
  private cBigFont valueSisaPulsaBeliPulsa = new cBigFont("5", 25, 60);
  ...
  private cRadioButton rd10k = new cRadioButton("10kg", "250000", 102, 190, 72);
  private cRadioButton rd25k = new cRadioButton("15kg", "375000", 179, 190, 72);
  private cRadioButton rd50k = new cRadioButton("20kg", "500000", 256, 190, 72);
  private cRadioButton rd100k = new cRadioButton("25K", "625000", 333, 190, 72);
  ...
  private cLabelInfo labelSisaKuotaBeliPaket = new cLabelInfo("Sisa Vitamin", 25, 20);
  private cBigFont valueSisaKuotaBeliPaket = new cBigFont("2", 25, 60);
  ...
  private cTextarea valueDeskripsiPaket = new cTextarea(false);

  // history beli pulsa components
  private cLabelInfo labelHistoryPulsa = new cLabelInfo("Semua Pembelian Telur Saya", 25, 20);
  ...
  private cLabelInfo labelHistoryPaket = new cLabelInfo("Semua Pembelian Vitamin Saya", 25, 20);
  ...
  private void initsHistoryBeliPulsa()
  {
    ...
    menuTitle.setText("Transaksi Telur Saya");
    String[] dataHistoryPulsaHeader = {"Telur", "Mitra", "Waktu", "Status"};
    String[][] dataHistoryPulsa = {
      {"Row1 Col1", "Row1 Col2", "Row1 Col3", "Row1 Col4"},
      {"5.000", "-", "2021-08-19 15:30:21", "diproses"},
      {"25.000", "Satwa Cell", "2021-08-19 15:21:20", "selesai"},
  ...
  private void initsHistoryBeliPaket()
  {
    ...
    String[] dataHistoryPaketHeader = {"Vitamin", "Kuota", "Harga", "Waktu", "Status"};
    String[][] dataHistoryPaket = {
      {"Row1 Col1", "Row1 Col2", "Row1 Col3", "Row1 Col4", "Row1 Col5"},
      {"Salam Telur", "5", "200.000", "2021-08-19 15:21:20", "selesai"},
